...
public class ConsumerGroupBNameCtl {
    ...
    public static void main(String[] args) {
        ...
        //消费者的组id
        props.put("group.id", "GroupB");//这里是GroupA或者GroupB  group组的名字 （做group组区分）
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records)
                ...
                System.out.printf("ConsumerGroupBNameCtl offset = %d, key = %s, value = %s", record.offset(), record.key(), record.value() + "\n");
